/*
// U3 - Pointers1.cpp : This file contains the 'main' function. Program execution begins and ends there.
// Shivam Vyas
// CIS-1202 800
// January 26, 2024
...
int main() {
    ...
    do {
        ...
        switch (choice) {
        case 1:
            enterRents(rents, NUM_PROPERTIES);
            break;
        case 2:
            displayRents(rents, NUM_PROPERTIES);
            break;
        case 3:
            selectionSort(rents, NUM_PROPERTIES);
            cout << "Rent amounts sorted in ascending order.\n";
            break;
        case 4:
            displayMemoryLocations(rents, NUM_PROPERTIES);
            break;
        case 5:
...
int getMenuItem() {
    ...
    cout << "4. Display memory locations\n";
    cout << "5. Exit\n";
...
// Function to enter rent amounts into an array, using subscripts
...
// Function to display rent amounts using subscripts
...
// Function to display memory locations of array elements, using subscripts
...
// Function to sort rent amounts using selection sort, using subscripts
